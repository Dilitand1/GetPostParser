...
public class Record {
    ...
    @JsonProperty("DeathActDate")
    public void setDeathActDate(String value) {
        this.deathActDate = value;
    }
    ...
    @JsonProperty("CaseIndex")
    public void setCaseIndex(String value) {
    ...
    @JsonProperty("CaseCloseDate")
    public void setCaseCloseDate(String value) {
        this.caseCloseDate = value;
    }
    ...
    @JsonProperty("NotaryStatus")
    public void setNotaryStatus(String value) {
        this.notaryStatus = value;
    }
    ...
    @JsonProperty("ChamberId")
    public void setChamberID(String value) {
    ...
    @JsonProperty("CaseIDDate")
    public void setCaseIDDate(String value) {
        this.caseIDDate = value;
    }
}